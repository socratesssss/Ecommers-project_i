...
// 🔁 Import shared data and types from central location
import { Product } from '../route'; // 👈 Make sure it's importing correctly

// Re-declare the same in-memory product array (you can extract to a shared file later)
const products: Product[] = [
  ...
  // ... Add other products (same as your existing array)
   {
    "id": 2,
